...
interface UseChainSentinelRewardOptions {
...
export function useChainSentinelReward({ paymentInNative = true, poolId = 0, price = '0.01', onSuccess, onError }: UseChainSentinelRewardOptions = {}) {
